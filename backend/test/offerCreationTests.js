var offerCreationController = require('../build/controllers/offerCreation.controller')
...
// #### Tests declarations ####
describe('offerCreation.controller', offerCreationTests);

function offerCreationTests() {
  beforeEach(async () => {
