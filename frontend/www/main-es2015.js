...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("<div class=\"container\">\n  <div [hidden]=\"submitted\">\n    <h1>Register</h1>\n    <form (ngSubmit)=\"onSubmit()\" #loginForm=\"ngForm\">\n      <div class=\"form-group\">\n        <label for=\"username\">Username</label>\n        <input type=\"text\" class=\"form-control\" id=\"username\" [(ngModel)]=\"model.username\" name=\"username\" #username=\"ngModel\" required/>\n        <div [hidden]=\"username.valid || username.pristine\" class=\"alert alert-danger\">\n          Username is required\n        </div>\n      </div>\n      <div class=\"form-group\">\n        <label for=\"password\">Password</label>\n        <input type=\"password\" class=\"form-control\" id=\"password\" [(ngModel)]=\"model.password\" name=\"password\" #password=\"ngModel\" required/>\n        <div [hidden]=\"password.valid || password.pristine\" class=\"alert alert-danger\">\n          Password is required\n        </div>\n      </div>\n      <button type=\"submit\" class=\"btn btn-success\" [disabled]=\"!loginForm.form.valid\" (click)=\"onSave(); loginForm.reset()\">New User</button>\n    </form>\n  </div>\n\n  <div [hidden]=\"!submitted\">\n    <h2>You submitted the following:</h2>\n    <div class=\"row\">\n      <div class=\"col-xs-3\">Username</div>\n      <div class=\"col-xs-9\">{{ model.username }}</div>\n    </div>\n    <div class=\"row\">\n      <div class=\"col-xs-3\">password</div>\n      <div class=\"col-xs-9\">{{ model.password }}</div>\n    </div>\n    <br />\n    <button class=\"btn btn-primary\" (click)=\"submitted=false\">Edit</button>\n  </div>\n</div>\n\n\n<!--\n<button (click)=\"forgotPassword()\">Forgot Password</button>\n<button (click)=\"openRegisterComponent()\">Register</button>\n-->\n");
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("<div class=\"container\">\n  <div [hidden]=\"submitted\">\n    <h1>Register</h1>\n    <form (ngSubmit)=\"onSubmit()\" #registerForm=\"ngForm\" appPasswordValid appEmailValid>\n      <div class=\"form-group\">\n        <label for=\"username\">Username</label>\n        <input type=\"text\" class=\"form-control\" id=\"username\" [(ngModel)]=\"model.username\" name=\"username\" #username=\"ngModel\" required/>\n        <div [hidden]=\"username.valid || username.pristine\" class=\"alert alert-danger\">\n          Username is required\n        </div>\n      </div>\n      <div class=\"cross-validation\" [class.cross-validation-error]=\"registerForm.errors?.passwordInvalid\">\n        <div class=\"form-group\">\n          <label for=\"password1\">Password</label>\n          <input type=\"password\" class=\"form-control\" id=\"password1\" [(ngModel)]=\"model.password1\" name=\"password1\" #password1=\"ngModel\" required/>\n          <div [hidden]=\"password1.valid || password1.pristine\" class=\"alert alert-danger\">\n            Password is required\n          </div>\n        </div>\n        <div class=\"form-group\">\n          <label for=\"password2\">Repeat Password</label>\n          <input type=\"password\" class=\"form-control\" id=\"password2\" [(ngModel)]=\"model.password2\" name=\"password2\" #password2=\"ngModel\" required/>\n          <div [hidden]=\"password2.valid || password2.pristine\" class=\"alert alert-danger\">\n            Please repeat your password\n          </div>\n          <div *ngIf=\"(password1.touched || password1.dirty) && (password2.touched || password2.dirty) && registerForm.errors?.passwordInvalid\" class=\"alert alert-danger\">\n            Your password is not identical\n          </div>\n        </div>\n      </div>\n      <div class=\"cross-validation\" [class.cross-validation-error]=\"registerForm.errors?.emailInvalid\">\n        <div class=\"form-group\">\n          <label for=\"email\">e-mail address</label>\n          <input type=\"email\" class=\"form-control\" id=\"email\" [(ngModel)]=\"model.email\" name=\"email\" #email=\"ngModel\" required/>\n          <div [hidden]=\"email.valid || email.pristine\" class=\"alert alert-danger\">\n            e-mail address is required\n          </div>\n          <div *ngIf=\"(email.touched || email.dirty) && registerForm.errors?.emailInvalid\" class=\"alert alert-danger\">\n            Please enter a valid e mail address\n          </div>\n        </div>\n      </div>\n      <div class=\"form-group\">\n        <label for=\"tel\">telephone number</label>\n        <input type=\"tel\" class=\"form-control\" id=\"tel\" [(ngModel)]=\"model.tel\" name=\"tel\"/>\n      </div>\n      <div class=\"form-group\">\n        <label for=\"address\">address</label>\n        <input type=\"tel\" class=\"form-control\" id=\"address\" [(ngModel)]=\"model.address\" name=\"address\"/>\n      </div>\n      <button type=\"submit\" class=\"btn btn-success\" [disabled]=\"!registerForm.form.valid\" (click)=\"onSave(); registerForm.reset()\" >New User</button>\n    </form>\n  </div>\n\n  <div [hidden]=\"!submitted\">\n    <h2>You submitted the following:</h2>\n    <div class=\"row\">\n      <div class=\"col-xs-3\">Username</div>\n      <div class=\"col-xs-9\">{{ model.username }}</div>\n    </div>\n    <div class=\"row\">\n      <div class=\"col-xs-3\">password</div>\n      <div class=\"col-xs-9\">{{ model.password1 }}</div>\n    </div>\n    <div class=\"row\">\n      <div class=\"col-xs-3\">password x2</div>\n      <div class=\"col-xs-9\">{{ model.password2 }}</div>\n    </div>\n    <div class=\"row\">\n      <div class=\"col-xs-3\">email</div>\n      <div class=\"col-xs-9\">{{ model.email }}</div>\n    </div>\n    <div class=\"row\">\n      <div class=\"col-xs-3\">tel</div>\n      <div class=\"col-xs-9\">{{ model.tel }}</div>\n    </div>\n    <div class=\"row\">\n      <div class=\"col-xs-3\">address</div>\n      <div class=\"col-xs-9\">{{ model.address }}</div>\n    </div>\n    <br />\n    <button class=\"btn btn-primary\" (click)=\"submitted=false\">Edit</button>\n  </div>\n</div>\n");

/***/ }),

/***/ "./node_modules/raw-loader/dist/cjs.js!./src/app/todo-list/todo-item/todo-item.component.html":
/*!****************************************************************************************************!*\
  !*** ./node_modules/raw-loader/dist/cjs.js!./src/app/todo-list/todo-item/todo-item.component.html ***!
  \****************************************************************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("<ion-row>\n  <ion-col size=\"5\">\n    <ion-input placeholder=\"Item Name\" name=\"name\" [(ngModel)]=\"todoItem.name\" (ngModelChange)=\"onSave()\"></ion-input>\n  </ion-col>\n  <ion-col size=\"1\">\n    <ion-checkbox [(ngModel)]=\"todoItem.done\" (ngModelChange)=\"onSave()\">Done</ion-checkbox>\n  </ion-col>\n  <ion-col size=\"2\">\n    <ion-button color=\"danger\" (click)=\"onDestroy()\">Delete Item</ion-button>\n  </ion-col>\n</ion-row>\n");
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("<ion-card>\n  <ion-row>\n    <ion-col size=\"6\">\n      <ion-input placeholder=\"List Name\" name=\"name\" [(ngModel)]=\"todoList.name\" (ngModelChange)=\"onSave()\"></ion-input>\n    </ion-col>\n    <ion-col size=\"2\">\n      <ion-button color=\"danger\" (click)=\"onDestroy()\">Delete List</ion-button>\n    </ion-col>\n  </ion-row>\n  <ion-row>\n    <ion-col size=\"6\">\n      <ion-input placeholder=\"Item Name\" name=\"name\" [(ngModel)]=\"todoItem.name\"></ion-input>\n    </ion-col>\n    <ion-col size=\"2\">\n      <ion-button (click)=\"onTodoItemCreate()\">Create Item</ion-button>\n    </ion-col>\n  </ion-row>\n  <app-todo-item [todoItem]=\"todoItem\" (destroy)=\"onTodoItemDestroy($event)\" *ngFor=\"let todoItem of todoItems\"></app-todo-item>\n</ion-card>\n");
...
/* harmony import */ var _todo_list__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./todo-list */ "./src/app/todo-list.ts");
...
let AppComponent = class AppComponent {
    constructor(platform, splashScreen, statusBar, httpClient) {
        this.platform = platform;
        this.splashScreen = splashScreen;
        this.statusBar = statusBar;
        this.httpClient = httpClient;
        this.todoList = new _todo_list__WEBPACK_IMPORTED_MODULE_5__["TodoList"](null, '');
        this.todoLists = [];
        this.initializeApp();
    }
    initializeApp() {
    ...
    ngOnInit() {
        this.httpClient.get('http://localhost:3000/todolist').subscribe((instances) => {
            this.todoLists = instances.map((instance) => new _todo_list__WEBPACK_IMPORTED_MODULE_5__["TodoList"](instance.id, instance.name));
        });
    }
    onTodoListCreate() {
...
/* harmony import */ var _todo_list_todo_item_todo_item_component__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./todo-list/todo-item/todo-item.component */ "./src/app/todo-list/todo-item/todo-item.component.ts");
/* harmony import */ var _register_register_component__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./register/register.component */ "./src/app/register/register.component.ts");
/* harmony import */ var _login_login_component__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./login/login.component */ "./src/app/login/login.component.ts");
/* harmony import */ var _passwordValidator_directive__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ./passwordValidator.directive */ "./src/app/passwordValidator.directive.ts");
/* harmony import */ var _emailValidator_directive__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ./emailValidator.directive */ "./src/app/emailValidator.directive.ts");
...
AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        declarations: [
            ...
            _todo_list_todo_item_todo_item_component__WEBPACK_IMPORTED_MODULE_11__["TodoItemComponent"],
            _login_login_component__WEBPACK_IMPORTED_MODULE_13__["LoginComponent"],
            _register_register_component__WEBPACK_IMPORTED_MODULE_12__["RegisterComponent"],
            _passwordValidator_directive__WEBPACK_IMPORTED_MODULE_14__["PasswordValidatorDirective"],
            _emailValidator_directive__WEBPACK_IMPORTED_MODULE_15__["EmailValidatorDirective"]
        ],
        entryComponents: [],
        imports: [
...
/***/ "./src/app/emailValidator.directive.ts":
/*!*********************************************!*\
  !*** ./src/app/emailValidator.directive.ts ***!
  \*********************************************/
/*! exports provided: emailValidatorDirective, EmailValidatorDirective */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
const emailValidatorDirective = (control) => {
...
/***/ "./src/app/passwordValidator.directive.ts":
/*!************************************************!*\
  !*** ./src/app/passwordValidator.directive.ts ***!
  \************************************************/
/*! exports provided: passwordValidatorDirective, PasswordValidatorDirective */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
const passwordValidatorDirective = (control) => {
...
PasswordValidatorDirective = PasswordValidatorDirective_1 = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Directive"])({
        ...
        providers: [{ provide: _angular_forms__WEBPACK_IMPORTED_MODULE_2__["NG_VALIDATORS"], useExisting: PasswordValidatorDirective_1, multi: true }]
    })
...
let RegisterComponent = class RegisterComponent {
    constructor(httpClient) {
        this.httpClient = httpClient;
        this.model = new _registration_user__WEBPACK_IMPORTED_MODULE_2__["RegistrationUser"]('', '', '', '');
        this.submitted = false;
    }
    onSubmit() { this.submitted = true; }
    ngOnInit() { }
...
class TodoItem {
    constructor(id, todoListId, name, done) {
        this.id = id;
...
/***/ "./src/app/todo-list/todo-item/todo-item.component.scss":
/*!**************************************************************!*\
  !*** ./src/app/todo-list/todo-item/todo-item.component.scss ***!
  \**************************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("\n/*# sourceMappingURL=data:application/json;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IiIsImZpbGUiOiJzcmMvYXBwL3RvZG8tbGlzdC90b2RvLWl0ZW0vdG9kby1pdGVtLmNvbXBvbmVudC5zY3NzIn0= */");

/***/ }),

/***/ "./src/app/todo-list/todo-item/todo-item.component.ts":
/*!************************************************************!*\
  !*** ./src/app/todo-list/todo-item/todo-item.component.ts ***!
  \************************************************************/
...
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
/* harmony import */ var _todo_item__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../todo-item */ "./src/app/todo-item.ts");
/* harmony import */ var _angular_common_http__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @angular/common/http */ "./node_modules/@angular/common/fesm2015/http.js");
...
tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    ...
    tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:type", _todo_item__WEBPACK_IMPORTED_MODULE_2__["TodoItem"])
], TodoItemComponent.prototype, "todoItem", void 0);
tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Output"])(),
    tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:type", Object)
], TodoItemComponent.prototype, "destroy", void 0);
TodoItemComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'app-todo-item',
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./todo-item.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/todo-list/todo-item/todo-item.component.html")).default,
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./todo-item.component.scss */ "./src/app/todo-list/todo-item/todo-item.component.scss")).default]
    }),
    tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_angular_common_http__WEBPACK_IMPORTED_MODULE_3__["HttpClient"]])
], TodoItemComponent);
...
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
/* harmony import */ var _todo_list__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../todo-list */ "./src/app/todo-list.ts");
/* harmony import */ var _todo_item__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../todo-item */ "./src/app/todo-item.ts");
/* harmony import */ var _angular_common_http__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @angular/common/http */ "./node_modules/@angular/common/fesm2015/http.js");
...
let TodoListComponent = class TodoListComponent {
    constructor(httpClient) {
        this.httpClient = httpClient;
        this.todoItem = new _todo_item__WEBPACK_IMPORTED_MODULE_3__["TodoItem"](null, null, '', false);
        this.todoItems = [];
        this.destroy = new _angular_core__WEBPACK_IMPORTED_MODULE_1__["EventEmitter"]();
    }
    ngOnInit() {
        this.httpClient.get('http://localhost:3000/todoitem', {
            params: new _angular_common_http__WEBPACK_IMPORTED_MODULE_4__["HttpParams"]().set('todoListId', '' + this.todoList.id)
        }).subscribe((instances) => {
            this.todoItems = instances.map((instance) => new _todo_item__WEBPACK_IMPORTED_MODULE_3__["TodoItem"](instance.id, instance.todoListId, instance.name, instance.done));
        });
    }
    onSave() {
    ...
    onTodoItemCreate() {
        ...
        this.httpClient.post('http://localhost:3000/todoitem', {
            ...
            this.todoItem = new _todo_item__WEBPACK_IMPORTED_MODULE_3__["TodoItem"](null, this.todoList.id, '', false);
        });
    }
    onTodoItemDestroy(todoItem) {
...
tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])(),
    tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:type", _todo_list__WEBPACK_IMPORTED_MODULE_2__["TodoList"])
], TodoListComponent.prototype, "todoList", void 0);
tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Output"])(),
    tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:type", Object)
], TodoListComponent.prototype, "destroy", void 0);
TodoListComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        ...
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./todo-list.component.scss */ "./src/app/todo-list/todo-list.component.scss")).default]
    }),
...
module.exports = __webpack_require__(/*! /home/michael/Documents/ESE/Github-Workspace/ESE-2019-Scaffolding/frontend/src/main.ts */"./src/main.ts");
